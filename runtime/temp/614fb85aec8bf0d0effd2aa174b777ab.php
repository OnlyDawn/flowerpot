<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\work\flowerpot\public/../application/admin\view\index\welcome.html";i:1543401513;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<script src="http://www.flowerpot.com\/static/admin/lib/echarts/echarts.js"></script>
		<script type="text/javascript">
			layui.use(['layer','jquery'], function(){
				...
				require.config({
				    paths: {
				        echarts: 'http://www.flowerpot.com\/static/admin/lib/echarts'
				    }
				});
				require(
				    [
