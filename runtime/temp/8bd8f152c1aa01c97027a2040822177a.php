<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\work\flowerpot\public/../application/admin\view\login\login.html";i:1544346921;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body>
		<div class="m-login-bg">
			<div class="m-login">
					...
					<form class="layui-form" method="post" action="/index.php/admin/login/verify">
						...
						<div class="layui-form-item">
							<div class="layui-inline">
								<input type="text" name="verity" style="width: 150px" required lay-verify="required" placeholder="验证码" autocomplete="off" class="layui-input">
							</div>
							<div class="layui-inline">
				...
				<p class="copyright">Copyright 2019 by CHUNLIN</p>
			</div>
		</div>
