<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\work\flowerpot\public/../application/admin\view\carousel\update.html";i:1543501791;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
							...
							<div class="layui-tab-item layui-show">
								...
								<div class="layui-form-item">
									...
									<div class="layui-upload">
										...
										<img src="http://www.flowerpot.com\\<?php echo $data['image']; ?>" alt="" width="200px">
									</div>
								</div>
								<div class="layui-form-item">
